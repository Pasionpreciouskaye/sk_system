        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-4 overflow-y-auto max-h-[90vh]">
            ...
            <form method="POST" action="{{ route('inventory.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring focus:ring-pink-500" required>
                </div>

                <!-- Quantity -->
                <div class="mb-4">
                    <label for="quantity" class="block text-gray-700 font-medium mb-1">Quantity</label>
                    <input type="number" name="quantity" id="quantity" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring focus:ring-pink-500" required>
                </div>

                <!-- Cost -->
                <div class="mb-6">
                    <label for="cost" class="block text-gray-700 font-medium mb-1">Cost (₱)</label>
                    <input type="number" step="0.01" name="cost" id="cost" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring focus:ring-pink-500" required>
                </div>
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button type="button" @click="showModal = false" class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400">
                        Cancel
                    </button>
                </div>
            </form>
