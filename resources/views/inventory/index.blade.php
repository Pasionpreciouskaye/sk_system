                ...
                <td class="py-2 px-4 text-left">
                    <div class="inline-flex space-x-2">
                        <div x-data="{ showEditModal: false }">
                            <button @click="showEditModal = true" class="p-2 bg-blue-100 text-blue-500 hover:bg-blue-200 rounded">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </button>
                            @include('cms.edit')
                        </div>
                        <div x-data="{ showDeleteModal: false }">
                            <button @click="showDeleteModal = true" class="p-2 bg-red-100 text-red-500 hover:bg-red-200 rounded">
