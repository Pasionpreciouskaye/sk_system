    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-4 overflow-y-auto max-h-[90vh]">
        ...
        <form method="POST" action="{{ route('inventory.update', $item->id) }}">
            ...
            <div class="mb-4">
                ...
                <select name="category_id" id="category_id" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-yellow-500 focus:border-yellow-500">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ $item->name }}"
                       class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-yellow-500 focus:border-yellow-500" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="number" step="0.01" name="cost" id="cost" value="{{ $item->cost }}"
                       class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-yellow-500 focus:border-yellow-500" required>
            </div>
