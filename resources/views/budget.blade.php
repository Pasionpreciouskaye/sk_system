...
<div class="p-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 mt-6">
        <!-- Total Allocated -->
        <div class="bg-pink-100 border border-pink-300 text-pink-800 rounded-lg p-6 shadow text-center transform transition duration-300 hover:-translate-y-1 hover:shadow-md">
            <div class="mb-2">
        ...
        <!-- Total Spent -->
        <div class="bg-green-100 border border-green-300 text-green-800 rounded-lg p-6 shadow text-center transform transition duration-300 hover:-translate-y-1 hover:shadow-md">
            <div class="mb-2">
        ...
        @endphp
        <div class="{{ $bgColor }} rounded-lg p-6 shadow text-center transform transition duration-300 hover:-translate-y-1 hover:shadow-md">
            <div class="mb-2">
    ...
    <!-- Budget Table (Centered + Left-Aligned Columns) -->
