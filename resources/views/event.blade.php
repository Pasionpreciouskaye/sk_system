...
<div class="p-16 bg-gray-50 min-h-screen">
    ...
    <div x-data="{ showModal: false, activeEvent: {} }">
        ...
        <!-- Modal -->
        <div x-show="showModal" x-cloak class="fixed inset-0 bg-black/70 z-[999] flex items-center justify-center p-4">
            <div @click.away="showModal = false" x-transition
                ...
                <div class="bg-pink-50 p-8 flex flex-col">
                    ...
                    <form :action="`/event/${activeEvent.id}/register`" method="POST"
