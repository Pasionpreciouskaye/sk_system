...
<div x-show="showModal" x-cloak
    ...
    <div @click.away="showModal = false" x-transition
        ...
        <div class="md:col-span-2 flex flex-col">
            ...
            <div class="p-6 overflow-auto prose prose-p:text-gray-700 prose-a:text-pink-600 max-h-[calc(90vh-16rem)]">
        ...
        <div class="bg-pink-50 p-8 flex flex-col">
            <button @click="showModal = false"
                class="self-end text-gray-500 hover:text-gray-800 mb-4 font-bold text-xl"
            ...
            <form action="{{ route('event.registration', $event->id) }}" method="POST"
